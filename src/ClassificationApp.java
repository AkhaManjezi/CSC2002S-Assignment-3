...
public class ClassificationApp {
    ...
    /**
     * Main method of Classification App
     *
     * @param args
     */
    public static void main(String[] args) {
        ...
        parallel();
//        sequential();
        output.data.writeData(outputFile, output.wind);
    }

    /**
     * Gets data from input file and creates a CloudData object of that data
     */
    static void getData() {
    ...
    /**
     * Sequential version of the prevailing wind and cloud classification algorithm
     */
...
//        int at;
        ...
        for (int i = 0; i < data.linAdvection.length; i += 3) {
            ...
            // Checking to see if we are at a boundary; if not, add
            if (at % data.dimx != 0) {
                //add left
